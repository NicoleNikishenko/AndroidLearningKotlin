...
import kotlinx.android.synthetic.main.image_big_item.view.*


class PhotoBigListAdapter(private val listener: PhotoAdapterListener) : ListAdapter <Photo, RecyclerView.ViewHolder>(PhotoDiffCallback()) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.image_big_item,parent,false))
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var photoImage: ImageView = itemView.photo_image_big
